    ...
    <section id="contact" className="py-24 bg-ice-navy text-white relative overflow-hidden premium-grain">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" ref={ref}>
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          >
            <h2 className="text-xs font-bold text-ice-teal-light uppercase tracking-[0.25em] mb-4">Get in Touch</h2>
            <h3 className="text-3xl md:text-4xl font-extralight text-white tracking-tight mb-6">Start the conversation.</h3>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h4 className="text-[10px] font-bold text-white/40 uppercase tracking-widest mb-1">Standby Activation (24/7)</h4>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h4 className="text-[10px] font-bold text-white/40 uppercase tracking-widest mb-1">General Inquiries</h4>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h4 className="text-[10px] font-bold text-white/40 uppercase tracking-widest mb-1">Headquarters</h4>
