...
export function Footer() {
  ...
  return (
    <footer className="bg-ice-navy text-white/50 py-20 font-light border-t border-white/5 premium-grain relative overflow-hidden" role="contentinfo">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <nav aria-label="Services navigation">
            ...
            <ul className="space-y-4 text-sm">
              <li><Link to="/services" className="hover:text-ice-teal-light transition-colors flex items-center gap-3 group"><div className="w-1 h-1 bg-white/20 rounded-full group-hover:bg-ice-teal transition-colors" /> Overview & Pricing</Link></li>
              <li><Link to="/process" className="hover:text-ice-teal-light transition-colors flex items-center gap-3 group"><div className="w-1 h-1 bg-white/20 rounded-full group-hover:bg-ice-teal transition-colors" /> The Process</Link></li>
              <li><Link to="/logistics" className="hover:text-ice-teal-light transition-colors flex items-center gap-3 group"><div className="w-1 h-1 bg-white/20 rounded-full group-hover:bg-ice-teal transition-colors" /> Transport & Logistics</Link></li>
            </ul>
          </nav>
          ...
          <nav aria-label="Company navigation">
            ...
            <ul className="space-y-4 text-sm">
              <li><Link to="/about" className="hover:text-ice-teal-light transition-colors flex items-center gap-3 group"><div className="w-1 h-1 bg-white/20 rounded-full group-hover:bg-ice-teal transition-colors" /> About ICE</Link></li>
              <li><Link to="/about#leadership" className="hover:text-ice-teal-light transition-colors flex items-center gap-3 group"><div className="w-1 h-1 bg-white/20 rounded-full group-hover:bg-ice-teal transition-colors" /> Leadership</Link></li>
              <li><Link to="/contact" className="hover:text-ice-teal-light transition-colors flex items-center gap-3 group"><div className="w-1 h-1 bg-white/20 rounded-full group-hover:bg-ice-teal transition-colors" /> Contact Us</Link></li>
            </ul>
          </nav>
          ...
          <div>
            ...
            <ul className="space-y-6 text-sm">
              <li className="flex items-start gap-4 p-4 bg-white/5 border border-white/10 rounded-lg">
                ...
                <div>
                  <span className="block text-[10px] font-bold text-white/30 uppercase tracking-wider mb-1">Standby (24/7)</span>
