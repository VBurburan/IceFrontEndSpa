          ...
          <AnimatedSection>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-slate-600 leading-relaxed border-l-4 border-cyan-200 pl-4 font-medium">
            ...
            {[
              ...
              <AnimatedSection key={card.title}>
                <motion.div
                  ...
                  className="bg-white p-8 rounded-lg shadow-sm border border-slate-200 h-full hover:shadow-md transition-shadow duration-300"
                >
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={item} className="flex items-center gap-3 p-3 bg-slate-50 rounded border border-slate-100 hover:border-cyan-200 hover:bg-cyan-50/30 transition-colors duration-200">
          ...
          <AnimatedSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
              {[
                ...
                <div key={reg.name} className="p-6 border-l-2 border-slate-200 hover:border-cyan-500 transition-colors">
                  <h3 className="text-lg font-bold text-slate-900 mb-3">{reg.name}</h3>
                  <p className="text-sm text-slate-600 leading-relaxed">{reg.desc}</p>
                </div>
              ))}
            </div>
          </AnimatedSection>
                ...
                <div className="p-10 lg:p-12 text-white">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 text-sm text-slate-300">
                    {['Treating physicians', 'Local funeral directors', 'Consulates & Embassies', 'Airline cargo depts', 'Customs brokers', 'Receiving CSOs'].map((item) => (
                      <div key={item} className="flex items-center gap-2"><Globe size={16} className="text-cyan-500"/> {item}</div>
                    ))}
                  </div>
                </div>
        ...
        <AnimatedSection>
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <a href="tel:844-468-5279" className="px-8 py-4 bg-slate-900 text-white font-bold uppercase tracking-widest rounded hover:bg-cyan-700 transition-colors text-sm">
                Urgent: 844-INTL-CRYO
              </a>
              <a href="mailto:info@cryomedics.org" className="px-8 py-4 border border-slate-300 text-slate-700 font-bold uppercase tracking-widest rounded hover:border-slate-900 hover:text-slate-900 transition-colors text-sm">
                Email Us
              </a>
            </div>
          </div>
